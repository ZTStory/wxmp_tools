...
export const DateUtils = {
    ...
    /**
     * 获取北京时间  
     * @param {Number}[timezone] 时区 东为-  西为+
     */
    getBJDate: function (timezone) {
     ...
     * @param {Number} offset 
     */
    dateFromOffsetDay: function (date, offset) {
        if (date === void 0) { date = DateUtil.getBJDate(); }
        if (offset === void 0) { offset = 1; }
        let nDate = new Date(date.getTime());
        nDate.setDate(date.getDate() + offset);
        return nDate;
    },
    /**
     * 旧格式化转新格式化
     ...
     * @param {String} newFmt 
     */
    oldToNewFormat: function (oldFmt, newFmt) {
        var date = new Date(oldFmt);
     ...
     * @param {Date} date2 
     */
    offsetFromTwoDate: function (date1, date2) {
    ...
    getWeekend: function (date) {
        ...
        var todayDate = new Date(this.getBJDate().format("yyyy-MM-dd")+"T00:00:00");
        var num = DateUtils.offsetFromTwoDate(currentDate, todayDate);
        switch (num) {
            case 0:
                return "今天";
            case 1:
            ...
            case 2:
                return "后天";
            default:
                return this.weekArray[date.getDay()];
        }
    },
}
